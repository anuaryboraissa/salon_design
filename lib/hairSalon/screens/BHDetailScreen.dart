...
import 'package:flutter_hair_salon_app_main/main/utils/flutter_rating_bar.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text('Monday - Friday',
                            style: TextStyle(color: BHGreyColor, fontSize: 14)),
                        Column(
                          children: [
                            Text('7:30 - 11:30 AM',
                                style: TextStyle(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('301 Dorthy walks,chicago,Us.',
                        style: TextStyle(color: BHColorPrimary, fontSize: 14)),
                  ],
                ),
              ),
            ],
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(BHTxtPopularServices,
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                      color: BHAppTextColorPrimary)),
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => BHPackageOffersScreen(),
                  ));
                },
