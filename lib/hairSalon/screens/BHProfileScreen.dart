                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => BHAccountInformationScreen(),
                        ));
                      },
                      child: Row(
                        children: [
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => BHInviteFriendsScreen(),
                        ));
                      },
                      child: Row(
                        children: [
