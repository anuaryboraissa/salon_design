import 'package:flutter_hair_salon_app_main/hairSalon/helpers/constants.dart';
...
class AppProvider with ChangeNotifier {
  ...
  _setPickupCoordinates({required LatLng coordinates}) {
    _locationCoordinates = coordinates;
    notifyListeners();
  }

  changeAddress({required String address}) {
