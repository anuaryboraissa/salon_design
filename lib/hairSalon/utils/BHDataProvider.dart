...
List<BHBestSpecialModel> getSpecialList() {
  List<BHBestSpecialModel> list = <BHBestSpecialModel>[];
  ...
  list.add(BHBestSpecialModel(title: 'Joseph Drake', subTitle: 'Makeup Artist', img: BHDashedBoardImage3));
  list.add(BHBestSpecialModel(title: 'Dale Horward', subTitle: 'Hire Stylist', img: BHDashedBoardImage6));
  list.add(BHBestSpecialModel(title: 'willies carpen', subTitle: 'Barber', img: BHDashedBoardImage3));
...
List<BHSpecialOfferModel> getSpecialOfferList() {
  List<BHSpecialOfferModel> specialOfferList = <BHSpecialOfferModel>[];
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage6, title: 'Joseph Salon', subtitle: 'Cool Summer Event'));
  ...
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage6, title: 'Barber Hair ', subtitle: 'Cool Winter Event'));
  ...
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage3, title: 'Joseph Hair', subtitle: 'Cool Summer Event'));
  return specialOfferList;
}

List<BHSpecialOfferModel> getSpecialOfferNewList() {
  List<BHSpecialOfferModel> specialOfferList = <BHSpecialOfferModel>[];
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage7, title: 'Joseph Drake Hair Salon', subtitle: 'Cool Summer Event'));
...
List<BHCallModel> getCallList() {
  List<BHCallModel> callList = <BHCallModel>[];
  callList.add(
    BHCallModel(
...
List<BHGalleryModel> getGalleryList() {
  List<BHGalleryModel> galleryList = <BHGalleryModel>[];
...
List<BHCategoryModel> getCategory() {
  List<BHCategoryModel> categoryList = <BHCategoryModel>[];
...
List<BHOfferModel> getOfferList() {
  List<BHOfferModel> offerList = <BHOfferModel>[];
  offerList.add(
...
List<BHServicesModel> getServicesList() {
  List<BHServicesModel> servicesList = <BHServicesModel>[];
...
List<BHIncludeServiceModel> getIncludeServicesList() {
  List<BHIncludeServiceModel> servicesList = <BHIncludeServiceModel>[];
...
List<BHReviewModel> getReviewList() {
  List<BHReviewModel> reviewList = <BHReviewModel>[];
...
List<BHHairStyleModel> getHairStyleList() {
  List<BHHairStyleModel> hairStyleList = <BHHairStyleModel>[];
...
List<BHMakeUpModel> getMakeupList() {
  List<BHMakeUpModel> makeupList = <BHMakeUpModel>[];
...
List<BHNotificationModel> getNotificationList() {
  List<BHNotificationModel> notificationList = <BHNotificationModel>[];
...
List<BHNotifyModel> getNotifyList() {
  List<BHNotifyModel> notifyList = <BHNotifyModel>[];
  notifyList.add(
