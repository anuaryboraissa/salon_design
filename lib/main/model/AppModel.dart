...
class ProTheme {
  ...
  ProTheme({required this.name, required this.icon, required this.is_theme, required this.tag, required this.type, required this.show_cover, this.sub_kits, required this.title_name, required this.darkThemeSupported, required this.widget});
