  ...
  Widget _buildRating(BuildContext context, int index) {
    ...
    if (index >= _rating) {
      ratingWidget = _NoRatingWidget(
        ...
        child: widget.ratingWidget!=null?widget.ratingWidget!.empty:Container(),
        enableMask: true,
          ...
          child: FittedBox(
            ...
            child: _isRTL
                ? Transform(
                    ...
                    alignment: Alignment.center,
                    transformHitTests: false,
                    child:widget.ratingWidget==null?null: widget.ratingWidget!.half,
                  )
                : widget.ratingWidget==null?null: widget.ratingWidget!.half,
          ),
        );
      }
      iconRating += 0.5;
      ...
      ratingWidget = SizedBox(
        ...
        child: FittedBox(
          fit: BoxFit.contain,
          child:widget.ratingWidget==null?null:
              widget.ratingWidget!.full,
        ),
      );
      iconRating += 1.0;
    }
